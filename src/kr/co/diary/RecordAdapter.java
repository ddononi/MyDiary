...
public class RecordAdapter extends BaseAdapter {
	...
	public RecordAdapter(final ArrayList<?> list) {
		this.list = list;
	}
	...
	private ViewGroup getViewGroup(final View reuse, final ViewGroup parent) {
		...
		ViewGroup item = (ViewGroup) inflater.inflate(R.layout.logging_custom_list, null);
		return item;
	}
